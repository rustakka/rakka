...
pub use snapshot_suite::{snapshot_extended_suite, snapshot_round_trip, snapshot_suite};
...
mod tests {
    ...
    #[tokio::test]
    async fn in_memory_snapshot_extended_suite() {
        snapshot_extended_suite(InMemorySnapshotStore::new(), "tck-s-ext").await;
    }
}
