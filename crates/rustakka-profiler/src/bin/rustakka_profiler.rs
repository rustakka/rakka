...
//!
//! ```text
//! rustakka-profiler [--scenario tell|ask|fanout|cpu|all]
//!                   [--messages N]
//!                   [--format md|json]
//!                   [--output FILE]
//! ```
...
use rustakka_profiler::{scenarios, ProfilerReport, Scenario};
...
fn help_text() -> &'static str {
    "rustakka-profiler — actor memory + CPU profiler\n\
     \n\
     USAGE:\n\
     \x20 rustakka-profiler [--scenario tell|ask|fanout|cpu|all]\n\
     \x20                   [--messages N]\n\
     \x20                   [--format md|json]\n\
     \x20                   [--output FILE]\n"
}
