...
/// Admin wrapper around [`rustakka_persistence::InMemoryJournal`].
/// Feature-gated.
#[cfg(feature = "persistence")]
pub struct InMemoryJournalAdmin {
    name: String,
    inner: Arc<rustakka_persistence::InMemoryJournal>,
}
...
impl InMemoryJournalAdmin {
    pub fn new(
        ...
        journal: Arc<rustakka_persistence::InMemoryJournal>,
    ) -> Self {
...
impl JournalAdmin for InMemoryJournalAdmin {
    ...
    async fn highest_sequence_nr_for(&self, pid: &str) -> u64 {
        use rustakka_persistence::Journal;
