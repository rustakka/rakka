//! OpenTelemetry exporter for `rustakka-telemetry`.
//!
...
impl OtelExporter {
    ...
    pub fn new(cfg: OtlpConfig) -> Result<Self, String> {
        Self::new_with_node(cfg, "rustakka-node")
    }
    ...
    pub fn new_with_node(cfg: OtlpConfig, node: impl Into<String>) -> Result<Self, String> {
        ...
        let service_name = cfg
            .service_name
            .clone()
            .unwrap_or_else(|| "rustakka".to_string());
