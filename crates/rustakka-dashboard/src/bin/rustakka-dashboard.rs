//! Standalone `rustakka-dashboard` binary. Launches a telemetry-backed
...
use rustakka_telemetry::exporters::config::{
...
#[derive(Parser, Debug)]
#[command(
    name = "rustakka-dashboard",
    about = "Serve the rustakka telemetry dashboard",
    version
)]
struct Args {
