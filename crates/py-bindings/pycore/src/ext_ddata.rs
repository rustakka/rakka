...
impl PyGCounter {
    #[new]
    fn new() -> Self { Self { inner: Mutex::new(GCounter::new()) } }
    fn increment(&self, node: String, delta: u64) { self.inner.lock().increment(&node, delta); }
    fn value(&self) -> u64 { self.inner.lock().value() }
...
impl PyPNCounter {
    #[new]
    fn new() -> Self { Self { inner: Mutex::new(PNCounter::new()) } }
    fn increment(&self, node: String, delta: u64) { self.inner.lock().increment(&node, delta); }
    fn decrement(&self, node: String, delta: u64) { self.inner.lock().decrement(&node, delta); }
    fn value(&self) -> i64 { self.inner.lock().value() }
...
impl PyGSet {
    #[new]
    fn new() -> Self { Self { inner: Mutex::new(GSet::new()) } }
    fn add(&self, item: String) { self.inner.lock().add(item); }
    fn contains(&self, item: String) -> bool { self.inner.lock().contains(&item) }
    fn size(&self) -> usize { self.inner.lock().len() }
...
impl PyORSet {
    #[new]
    fn new() -> Self { Self { inner: Mutex::new(OrSet::new()) } }
    fn add(&self, item: String) { self.inner.lock().add(item); }
    fn remove(&self, item: String) { self.inner.lock().remove(&item); }
    fn contains(&self, item: String) -> bool { self.inner.lock().contains(&item) }
