"""Smoke tests for rustakka.profiler."""
...
import rustakka
from rustakka.profiler import DEFAULT_MESSAGES, SCENARIOS, run
from rustakka.profiler._probes import best_dispatcher_for, rss_bytes
from rustakka.profiler._report import (
    Measurement,
    ProfilerReport,
    fmt_ns,
    fmt_rate,
...
def test_run_tiny_subset_produces_valid_report():
    ...
    assert report.version == rustakka.__version__
