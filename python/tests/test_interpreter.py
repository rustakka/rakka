...
def test_configure_interpreter_with_quota():
    ...
    try:
        ...
        metrics = rustakka._native.interpreter_metrics()
...
def test_compat_declare_and_lookup():
    rustakka.declare_compat("mylib", subinterpreter_safe=True, nogil_safe=False, notes="custom")
    flags = rustakka.compat_flags("mylib")
...
def test_interpreter_quota_rejects_overload():
    ...
    try:
        ...
        try:
            ...
            raised = False
        except rustakka.InterpreterOverloaded:
            raised = True
